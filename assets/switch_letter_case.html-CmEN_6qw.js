import{_ as n,o as s,c as a,e as t}from"./app-BPTRJqJi.js";const e={},p=t(`<h2 id="switch-letter-case" tabindex="-1"><a class="header-anchor" href="#switch-letter-case" aria-hidden="true">#</a> Switch letter Case</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token doc-comment comment">/**
   * 1.使用正则
